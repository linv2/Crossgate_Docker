...
hunter_list[1].level_max = 150;
hunter_list[1].limit = 2;
hunter_list[1].target[1] = {};
hunter_list[1].target[1].name = "小石像怪";
hunter_list[1].target[1].amount = 5;
...
hunter_list[2].level_max = 150;
hunter_list[2].limit = 3;
hunter_list[2].target[1] = {};
hunter_list[2].target[1].name = "哥布林";
hunter_list[2].target[1].amount = 10;
hunter_list[2].target[2] = {};
hunter_list[2].target[2].name = "盗贼";
hunter_list[2].target[2].amount = 10;
...
hunter_list[5].level_max = 150;
hunter_list[5].limit = 5;
hunter_list[5].target[1] = {};
hunter_list[5].target[1].name = "长老树精";
...
hunter_list[9].level_max = 150;
hunter_list[9].limit = 5;
hunter_list[9].target[1] = {};
hunter_list[9].target[1].name = "神兽";
...
hunter_list[13].name = "《双王无解封印》";
hunter_list[13].level_min = 70;
hunter_list[13].level_max = 150;
hunter_list[13].limit = 5;
hunter_list[13].target[1] = {};
hunter_list[13].target[1].name = "凯法";
hunter_list[13].target[1].amount = 1;
hunter_list[13].target[2] = {};
hunter_list[13].target[2].name = "帕布提斯马";
hunter_list[13].target[2].amount = 1;
hunter_list[13].reward.gold = 350;
hunter_list[13].reward.fame = 100;
hunter_list[13].reward.experience = 45000;
hunter_list[13].reward.item[1] = 
{
					id = 70012;
					name = "佣兵积分";
					amount = 60;
...
hunter_list[14] = {};
hunter_list[14].target = {}
hunter_list[14].reward = {};
hunter_list[14].reward.item = {};
hunter_list[14].name = "《军神李贝留斯》";
hunter_list[14].level_min = 80;
hunter_list[14].level_max = 150;
hunter_list[14].limit = 5;
hunter_list[14].target[1] = {};
hunter_list[14].target[1].name = "李贝留斯";
hunter_list[14].target[1].amount = 1;
hunter_list[14].reward.gold = 500;
hunter_list[14].reward.fame = 100;
hunter_list[14].reward.experience = 50000;
hunter_list[14].reward.item[1] = 
{
					id = 70012;
					name = "佣兵积分";
					amount = 70;
...
hunter_list.count = table.getn(hunter_list);
for i = 1, hunter_list.count do
	hunter_list[i].target.count = table.getn(hunter_list[i].target);
end
...
function hunter_create() --佣兵任务
	if(hunter_index == nil)then
		hunter_index = NL.CreateNpc("lua/Module/hunter.lua","hunter_initialize")
		Char.SetData(hunter_index,%对象_形象%,100454);
		Char.SetData(hunter_index,%对象_原形%,100454);
		Char.SetData(hunter_index,%对象_X%,107);
		Char.SetData(hunter_index,%对象_Y%,83);
		Char.SetData(hunter_index,%对象_地图%,1000);
		Char.SetData(hunter_index,%对象_方向%,4);
		Char.SetData(hunter_index,%对象_名字%,"佣兵任务发放员");
...
function hunter_callback_talk( _index_me, _index_tome)
	local message = "5"..
			...
			"\\n提交任务"..
			"\\n放弃任务";
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, %按钮_关闭%, 
...
function hunter_show_list( _index_me, _index_tome, _page)
	...
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, button, 
...
function hunter_show_quest( _index_me, _index_tome, _number)
	...
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, %按钮_是否%, 
...
function hunter_show_ongoing( _index_me, _index_tome)
	...
	--NLG.ShowWindowTalked( _index_tome, _index_me, 2, 1, HUNTER_WINDOW_SEQUENCE_ONGOING, message);
	--NLG.ShowWindowTalked( _index_tome, _index_me, 2, 1, HUNTER_WINDOW_SEQUENCE_ONGOING, message);
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, 1, HUNTER_WINDOW_SEQUENCE_ONGOING, message);
...
function hunter_submit( _index_me, _index_tome)
	...
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, button, sequence, message);
end
...
function hunter_show_cancel( _index_me, _index_tome)
	...
	if( flag == 0 or flag == nil)then
		local message = "\\n没有正在进行的任务。";
		NLG.ShowWindowTalked( _index_tome, _index_me, 2, 1, HUNTER_WINDOW_SEQUENCE_NONE, message);
		return;
	end
	local message = "\\n放弃任务需缴纳违约金魔币1000，且会计算入任务限制数量中，你确定吗？";
	NLG.ShowWindowTalked( _index_tome, _index_me, 2, %按钮_是否%, HUNTER_WINDOW_SEQUENCE_CANCEL, message);
end
...
function hunter_talk_check( _index, _message, _color, _range, _size)
	if( tonumber( Field.Get( _index,"hunter_flag")) == 0 or tonumber( Field.Get( _index, "hunter_flag")) == nil)then
		NLG.SystemMessage( _index, "[佣兵任务]没有接任务。");
	end
	...
	if( tonumber( Field.Get( _index, "hunter_flag")) == 2)then
		NLG.SystemMessage( _index, "[佣兵任务]任务已经完成，可以提交。");
	end
	return false;
end